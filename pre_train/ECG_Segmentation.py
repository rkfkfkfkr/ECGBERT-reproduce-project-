...
def process_and_save_segments(processed_data_dir, save_dir, dataset, fs):
...
def ECG_Segmentation(datasets, dir):
    
    fs = 500
    
    for dataset in datasets:
        processed_data_dir = os.path.join(dir, f'ECG_Preprocessing')
        save_dir = os.path.join(dir, f'ECG_Segmentation')
        
        process_and_save_segments(processed_data_dir, save_dir, dataset, fs)